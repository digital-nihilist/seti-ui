...
const font = '.build/_fonts/seti/seti.woff',
	fontMappingsFile = '.build/_fonts/seti.less',
...
exports.update = function () {
	...
	function writeFileIconContent() {
		...
		//let path = './.build/_fonts/seti/vs-seti-icon-theme.json';
